...
-->
        ...
        <xsl:template name="simple_value_tpl_3">
                <xsl:param name="name"/>
                <xsl:param name="label"/>
                <xsl:param name="repeatLabel" select="1"/>
                <xsl:if test="not($repeatLabel='1')">
                        ...
                        <DD>
                                <DL>
                                        ...
                                        <xsl:call-template name="simple_value_tpl_3">
                                                ...
                                                <xsl:with-param name="label" select="'Other constraints: '"/>
                                                <xsl:with-param name="repeatLabel" select="'0'"/>
                                        </xsl:call-template>
                                </DL>
                        </DD>
                </DD>
