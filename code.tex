...
\begin{flushleft}
\ttfamily\noindent
\hlcomment{\usebox{\hlnormalsizeboxhash}{\ }Match.}\hspace*{\fill}\\
\hlstd{}\hlsymbol{map}\hlkeyword{\usebox{\hlnormalsizeboxat}}\hlslot{data}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{id}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{rownames}\hlkeyword{(}\hlsymbol{map}\hlkeyword{\usebox{\hlnormalsizeboxat}}\hlslot{data}\hlkeyword{)}{\ }{\ }\hlcomment{\usebox{\hlnormalsizeboxhash}{\ }coded{\ }by{\ }Hadley{\ }Wickham{\ }(thanks!)}\hspace*{\fill}\\
\hlstd{}\hlsymbol{map.points}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{fortify}\hlkeyword{(}\hlsymbol{map}\hlkeyword{,}{\ }\hlargument{region}{\ }\hlargument{=}{\ }\hlstring{"{}id"{}}\hlkeyword{)}{\ }{\ }\hlcomment{\usebox{\hlnormalsizeboxhash}{\ }fixed{\ }by{\ }Roger{\ }Peng{\ }(thanks!)}\hspace*{\fill}\\
\hlstd{}\hlsymbol{map.df}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{join}\hlkeyword{(}\hlsymbol{map.points}\hlkeyword{,}{\ }\hlsymbol{map}\hlkeyword{\usebox{\hlnormalsizeboxat}}\hlslot{data}\hlkeyword{,}{\ }\hlargument{by}{\ }\hlargument{=}{\ }\hlstring{"{}id"{}}\hlkeyword{)}{\ }{\ }\hlcomment{\usebox{\hlnormalsizeboxhash}{\ }match{\ }map{\ }and{\ }rows}\hspace*{\fill}\\
\hlstd{}\hlsymbol{map.df}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{join}\hlkeyword{(}\hlsymbol{map.df}\hlkeyword{,}{\ }\hlsymbol{eco}\hlkeyword{,}{\ }\hlargument{by}{\ }\hlargument{=}{\ }\hlstring{"{}iso2"{}}\hlkeyword{)}{\ }{\ }\hlcomment{\usebox{\hlnormalsizeboxhash}{\ }match{\ }map{\ }and{\ }data}\mbox{}
\normalfont
\end{flushleft}
\end{kframe}
\end{knitrout}
...
\centering{}\includegraphics[width=0.75\textwidth,height=0.75\textwidth]{figures/map-mr_m} 
...
\centering{}\includegraphics[width=0.75\textwidth,height=0.75\textwidth]{figures/map-mr_f} 
